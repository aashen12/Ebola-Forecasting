...
rm(list=ls())
source("/Users/andyshen/Desktop/Desktop - Andy’s MacBook Pro/Git/Ebola-Forecasting/Post Outbreak/outbreak_vis.R") #script with functions
...
ggsave(
  "hawkes7_all.jpg", 
  path = "/Users/andyshen/Library/Mobile Documents/com~apple~CloudDocs/Desktop/Desktop - Andy’s MacBook Pro/Ebola Modeling/Submission 2",
...
p +
  ...
  scale_color_identity(
    ...
    guide = "legend"
  ) + labs(y = "Difference between true and forecasted cases")
ggsave(
  "hawkes_resids.jpg",
  path = "/Users/andyshen/Library/Mobile Documents/com~apple~CloudDocs/Desktop/Desktop - Andy’s MacBook Pro/Ebola Modeling/Submission 2",
  width = 5.5, height = 5.5, units = "in"
