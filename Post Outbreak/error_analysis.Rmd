...
# 5 Omission of Duplicate Entries

Many of the forecasts were run with the same date. These duplicate runs are likely due to minor adjustments in the previous numbers, so we refine our data to omit the duplicate forecasts and only consider the most recent forecast with a duplicate date.
